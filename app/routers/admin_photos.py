...
def compress_image(image_bytes: bytes, max_width: int = 1920, max_height: int = 1080, quality: int = 85) -> bytes:
    """Redimensiona e comprime a imagem em memória utilizando o Pillow."""
    image = Image.open(io.BytesIO(image_bytes))

    # Converter para RGB se for RGBA (PNG com transparência) para evitar erro ao guardar como JPEG
